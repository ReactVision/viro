...
const Viro3DSceneNavigatorModule =
  react_native_1.NativeModules.VRT3DSceneNavigatorModule;
...
class Viro3DSceneNavigator extends React.Component {
  ...
  _recenterTracking() {
    Viro3DSceneNavigatorModule.recenterTracking(
...
var VRT3DSceneNavigator = (0, react_native_1.requireNativeComponent)(
  "VRT3DSceneNavigator",
  // @ts-ignore

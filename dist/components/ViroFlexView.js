...
var VROFlexView = react_native_1.requireNativeComponent('VRTFlexView', ViroFlexView, {
    nativeOnly: {
        canHover: true,
        canClick: true,
        canTouch: true,

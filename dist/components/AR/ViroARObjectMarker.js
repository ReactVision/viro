 ...
 */
var ViroARObjectMarker = createReactClass({
    propTypes: __assign(__assign({}, react_native_1.View.propTypes), { target: prop_types_1.default.string, pauseUpdates: prop_types_1.default.bool, visible: prop_types_1.default.bool, opacity: prop_types_1.default.number, ignoreEventHandling: prop_types_1.default.bool, dragType: prop_types_1.default.oneOf(["FixedDistance", "FixedDistanceOrigin", "FixedToWorld", "FixedToPlane"]), dragPlane: prop_types_1.default.shape({
...
module.exports = ViroARObjectMarker;

...
var Viro3DSceneNavigator = createReactClass({
    ...
    _project: function (point) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, Viro3DSceneNavigatorModule.project(react_native_1.findNodeHandle(this), point)];
    ...
    _unproject: function (point) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, Viro3DSceneNavigatorModule.unproject(react_native_1.findNodeHandle(this), point)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    ...
    render: function () {
        ...
        return (<VRT3DSceneNavigator ref={function (component) { _this._component = component; }} {...this.props} currentSceneIndex={this.state.currentSceneIndex} style={this.props.style, styles.container} hasOnExitViroCallback={this.props.onExitViro != undefined} onExitViro={this._onExitViro}>
        {items}
      </VRT3DSceneNavigator>);
    },
});
...
var VRT3DSceneNavigator = react_native_1.requireNativeComponent('VRT3DSceneNavigator', Viro3DSceneNavigator, {

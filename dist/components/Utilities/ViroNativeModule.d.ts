 ...
 */
export declare function withMissingModuleFallback<T extends object>(nativeModule: T | null | undefined, moduleName: string): T;
/** Test seam: forgets what has already been warned about. */
export declare function resetMissingModuleWarnings(): void;

...
var ViroVideo = createReactClass({
    propTypes: __assign(__assign({}, react_native_1.View.propTypes), { position: prop_types_1.default.arrayOf(prop_types_1.default.number), rotation: prop_types_1.default.arrayOf(prop_types_1.default.number), scale: prop_types_1.default.arrayOf(prop_types_1.default.number), scalePivot: prop_types_1.default.arrayOf(prop_types_1.default.number), rotationPivot: prop_types_1.default.arrayOf(prop_types_1.default.number), opacity: prop_types_1.default.number, renderingOrder: prop_types_1.default.number, visible: prop_types_1.default.bool, materials: prop_types_1.default.oneOfType([
            ...
            prop_types_1.default.arrayOf(prop_types_1.default.string),
            prop_types_1.default.string
        ]), highAccuracyEvents: prop_types_1.default.bool, lightReceivingBitMask: prop_types_1.default.number, shadowCastingBitMask: prop_types_1.default.number, onTransformUpdate: prop_types_1.default.func, stereoMode: prop_types_1.default.oneOf(['LeftRight', 'RightLeft', 'TopBottom', 'BottomTop', 'None']), width: prop_types_1.default.number, height: prop_types_1.default.number, paused: prop_types_1.default.bool, loop: prop_types_1.default.bool, muted: prop_types_1.default.bool, volume: prop_types_1.default.number, source: prop_types_1.default.oneOfType([
            prop_types_1.default.shape({
                uri: prop_types_1.default.string,
            }),
            // Opaque type returned by require('./test_video.mp4')
            prop_types_1.default.number
        ]).isRequired, ignoreEventHandling: prop_types_1.default.bool, dragType: prop_types_1.default.oneOf(["FixedDistance", "FixedDistanceOrigin", "FixedToWorld", "FixedToPlane"]), dragPlane: prop_types_1.default.shape({
    ...
    seekToTime: function (timeInSeconds) {
        switch (react_native_1.Platform.OS) {
            case 'ios':
                NativeModules.VRTVideoSurfaceManager.seekToTime(react_native_1.findNodeHandle(this), timeInSeconds);
                break;
            case 'android':
                NativeModules.UIManager.dispatchViewManagerCommand(react_native_1.findNodeHandle(this), NativeModules.UIManager.VRTVideoSurface.Commands.seekToTime, [timeInSeconds]);
                break;
        }
    },
});
var VRTVideoSurface = react_native_1.requireNativeComponent('VRTVideoSurface', ViroVideo, {
    nativeOnly: {

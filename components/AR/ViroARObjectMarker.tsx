 ...
 */
export class ViroARObjectMarker extends ViroBase<Props> {
  ...
  render() {
    ...
    if (isVisionOS) {
      warnUnsupported("ViroARObjectMarker", "Apple Vision Pro", "Object tracking comes from the AR subsystem, which visionOS does not carry.");
      return null;
    }
    if (isQuest) {

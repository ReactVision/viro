...
var ViroAnimationValidation = /** @class */ (function () {
    function ViroAnimationValidation() {
    }
    ViroAnimationValidation.validateAnimationProp = function (prop, animationName, animation, caller) {
        if (!__DEV__) {
            return;
        }
    ...
    ViroAnimationValidation.validateAnimation = function (name, animations) {
        if (!__DEV__) {
            return;
        }
     ...
     */
    ViroAnimationValidation.validateAnimationChain = function (name, animations) {
        if (!__DEV__) {
            return;
        }
    ...
    ViroAnimationValidation.addValidAnimationPropTypes = function (animationPropTypes) {

...
exports.studioAssetPosition = studioAssetPosition;
 ...
 */
function studioAssetPosition(asset) {
    ...
    if (!asset.trigger_image_url &&
        !isTapToPlace &&
        !isWorldPlacement &&
        posZ > -0.5) {
        console.warn(`[Studio] Asset "${asset.name}" Z=${posZ} too close, clamping to -2`);
        posZ = -2;
    }

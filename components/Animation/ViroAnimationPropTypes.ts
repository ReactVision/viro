...
export const ViroAnimationPropTypes = {
  ...
  properties: createStrictShapeTypeChecker({
    ...
    positionZ: PropTypes.oneOfType([PropTypes.number, PropTypes.string]),

    scaleX: PropTypes.oneOfType([PropTypes.number, PropTypes.string]),

    scaleY: PropTypes.oneOfType([PropTypes.number, PropTypes.string]),

    scaleZ: PropTypes.oneOfType([PropTypes.number, PropTypes.string]),

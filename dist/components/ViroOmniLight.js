...
var ViroOmniLight = createReactClass({
    propTypes: __assign(__assign({}, react_native_1.View.propTypes), { position: prop_types_1.default.arrayOf(prop_types_1.default.number), color: ColorPropType, intensity: prop_types_1.default.number, temperature: prop_types_1.default.number, influenceBitMask: prop_types_1.default.number, attenuationStartDistance: prop_types_1.default.number, attenuationEndDistance: prop_types_1.default.number }),
...
var VRTOmniLight = react_native_1.requireNativeComponent('VRTOmniLight', ViroOmniLight);

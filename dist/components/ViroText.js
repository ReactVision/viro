...
var ViroText = createReactClass({
    propTypes: __assign(__assign({}, react_native_1.View.propTypes), { position: prop_types_1.default.arrayOf(prop_types_1.default.number), rotation: prop_types_1.default.arrayOf(prop_types_1.default.number), text: prop_types_1.default.string.isRequired, rotationPivot: prop_types_1.default.arrayOf(prop_types_1.default.number), color: ColorPropType, extrusionDepth: prop_types_1.default.number, outerStroke: prop_types_1.default.shape({
            type: prop_types_1.default.oneOf(['None', 'Outline', 'DropShadow']),
            width: prop_types_1.default.number,
            color: ColorPropType
        }), width: prop_types_1.default.number, height: prop_types_1.default.number, maxLines: prop_types_1.default.number, textClipMode: prop_types_1.default.oneOf(['None', 'ClipToBounds']), textLineBreakMode: prop_types_1.default.oneOf(['WordWrap', 'CharWrap', 'Justify', 'None']), renderingOrder: prop_types_1.default.number, visible: prop_types_1.default.bool, style: stylePropType, materials: prop_types_1.default.oneOfType([
        ...
        }), onTransformUpdate: prop_types_1.default.func, onHover: prop_types_1.default.func, onClick: prop_types_1.default.func, onClickState: prop_types_1.default.func, onTouch: prop_types_1.default.func, onScroll: prop_types_1.default.func, onSwipe: prop_types_1.default.func, onDrag: prop_types_1.default.func, onPinch: prop_types_1.default.func, onRotate: prop_types_1.default.func, onFuse: prop_types_1.default.oneOfType([
    ...
    render: function () {
        ...
        var outerStroke = undefined;
        if (this.props.outerStroke) {
            var outerStrokeColor = this.props.outerStroke.color;
            var processedColor = processColor(outerStrokeColor);
            outerStroke = {

...
([tinyvio](https://github.com/ReactVision/tinyvio), built as `tinyvio-slam.wasm`) for tracking.

> **Shipping in 3.0.0**, against `@reactvision/viro-web-renderer` 1.0.0. 3D scenes
> and AR — camera, 6-DoF pose, plane detection and hit-test — both work on desktop
> and mobile web. The gaps are listed under *Not yet on web* below; everything else

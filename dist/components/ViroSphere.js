 ...
 */
class ViroSphere extends ViroBase_1.ViroBase {
    render() {
        (0, ViroProps_1.checkMisnamedProps)("ViroSphere", this.props);
...
var VRTSphere = (0, react_native_1.requireNativeComponent)("VRTSphere", 
// @ts-ignore
ViroSphere, {
    nativeOnly: {
        canHover: true,

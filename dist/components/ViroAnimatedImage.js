...
var ViroAnimatedImage = createReactClass({
    propTypes: __assign(__assign({}, react_native_1.View.propTypes), { source: prop_types_1.default.oneOfType([
        ...
        }), renderingOrder: prop_types_1.default.number, viroTag: prop_types_1.default.string, onCollision: prop_types_1.default.func }),
...
var VRTAnimatedImage = react_native_1.requireNativeComponent('VRTAnimatedImage', ViroAnimatedImage, {
    nativeOnly: {

 ...
 */
export function polarToCartesian(polarcoords: any): number[];
/**
 * Convert the given polar coords of the form [r, theta, phi] to cartesian
 ...
 */
export function polarToCartesianActual(polarcoords: any): number[];
export function isARSupportedOnDevice(notSupportedCallback: any, supportedCallback: any): void;

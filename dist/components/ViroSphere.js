...
var ViroSphere = createReactClass({
    propTypes: __assign(__assign({}, react_native_1.View.propTypes), { position: prop_types_1.default.arrayOf(prop_types_1.default.number), scale: prop_types_1.default.arrayOf(prop_types_1.default.number), rotation: prop_types_1.default.arrayOf(prop_types_1.default.number), scalePivot: prop_types_1.default.arrayOf(prop_types_1.default.number), rotationPivot: prop_types_1.default.arrayOf(prop_types_1.default.number), renderingOrder: prop_types_1.default.number, visible: prop_types_1.default.bool, opacity: prop_types_1.default.number, widthSegmentCount: prop_types_1.default.number, heightSegmentCount: prop_types_1.default.number, radius: prop_types_1.default.number, facesOutward: prop_types_1.default.bool, materials: prop_types_1.default.oneOfType([
            ...
            prop_types_1.default.arrayOf(prop_types_1.default.string),
            prop_types_1.default.string
        ]), ignoreEventHandling: prop_types_1.default.bool, dragType: prop_types_1.default.oneOf(["FixedDistance", "FixedDistanceOrigin", "FixedToWorld", "FixedToPlane"]), dragPlane: prop_types_1.default.shape({
        ...
        }), lightReceivingBitMask: prop_types_1.default.number, shadowCastingBitMask: prop_types_1.default.number, onTransformUpdate: prop_types_1.default.func, onHover: prop_types_1.default.func, onClick: prop_types_1.default.func, onClickState: prop_types_1.default.func, onTouch: prop_types_1.default.func, onScroll: prop_types_1.default.func, onSwipe: prop_types_1.default.func, onFuse: prop_types_1.default.oneOfType([
        ...
        highAccuracyGaze: prop_types_1.default.bool, onDrag: prop_types_1.default.func, onPinch: prop_types_1.default.func, onRotate: prop_types_1.default.func, physicsBody: prop_types_1.default.shape({
    ...
    applyImpulse: function (force, atPosition) {
        NativeModules.VRTNodeModule.applyImpulse(react_native_1.findNodeHandle(this), force, atPosition);
    },
    ...
    render: function () {
        var _this = this;
        ViroProps_1.checkMisnamedProps("ViroSphere", this.props);

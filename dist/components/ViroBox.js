...
var ViroBox = createReactClass({
    propTypes: __assign(__assign({}, react_native_1.View.propTypes), { position: prop_types_1.default.arrayOf(prop_types_1.default.number), scale: prop_types_1.default.arrayOf(prop_types_1.default.number), rotation: prop_types_1.default.arrayOf(prop_types_1.default.number), scalePivot: prop_types_1.default.arrayOf(prop_types_1.default.number), rotationPivot: prop_types_1.default.arrayOf(prop_types_1.default.number), renderingOrder: prop_types_1.default.number, visible: prop_types_1.default.bool, opacity: prop_types_1.default.number, width: prop_types_1.default.number, height: prop_types_1.default.number, length: prop_types_1.default.number, materials: prop_types_1.default.oneOfType([
            ...
            prop_types_1.default.arrayOf(prop_types_1.default.string),
            prop_types_1.default.string
        ]), lightReceivingBitMask: prop_types_1.default.number, shadowCastingBitMask: prop_types_1.default.number, ignoreEventHandling: prop_types_1.default.bool, dragType: prop_types_1.default.oneOf(["FixedDistance", "FixedDistanceOrigin", "FixedToWorld", "FixedToPlane"]), dragPlane: prop_types_1.default.shape({
        ...
        highAccuracyGaze: prop_types_1.default.bool, physicsBody: prop_types_1.default.shape({
    ...
    render: function () {
        var _this = this;
        ViroProps_1.checkMisnamedProps("ViroBox", this.props);

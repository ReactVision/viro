...
var ViroVRSceneNavigator = createReactClass({
    ...
    render: function () {
        ...
        return (<VRTVRSceneNavigator ref={function (component) { _this._component = component; }} {...this.props} currentSceneIndex={this.state.currentSceneIndex} style={this.props.style, styles.container} hasOnExitViroCallback={this.props.onExitViro != undefined} onExitViro={this._onExitViro}>
        {items}
      </VRTVRSceneNavigator>);
    },
});
...
var VRTVRSceneNavigator = react_native_1.requireNativeComponent('VRTVRSceneNavigator', ViroVRSceneNavigator, {

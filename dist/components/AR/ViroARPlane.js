...
var ViroARPlane = createReactClass({
    propTypes: __assign(__assign({}, react_native_1.View.propTypes), { anchorId: prop_types_1.default.string, minHeight: prop_types_1.default.number, minWidth: prop_types_1.default.number, alignment: prop_types_1.default.oneOf(["Horizontal", "HorizontalUpward", "HorizontalDownward", "Vertical"]), pauseUpdates: prop_types_1.default.bool, renderingOrder: prop_types_1.default.number, visible: prop_types_1.default.bool, opacity: prop_types_1.default.number, ignoreEventHandling: prop_types_1.default.bool, dragType: prop_types_1.default.oneOf(["FixedDistance", "FixedDistanceOrigin", "FixedToWorld", "FixedToPlane"]), dragPlane: prop_types_1.default.shape({

...
var AssetRegistry_1 = __importDefault(require("react-native/Libraries/Image/AssetRegistry"));
...
var ViroMaterials = /** @class */ (function () {
    function ViroMaterials() {
    }
    ViroMaterials.createMaterials = function (materials /*:{[key: string]: any}*/) {
        var result = {};
                ...
                if (materialProperty.endsWith('texture') || materialProperty.endsWith('Texture')) {
                    ...
                    if ((materialProperty === 'ReflectiveTexture') || (materialProperty === 'reflectiveTexture')) {
                        ...
                        for (var cubeMapTexture in materialDict[materialProperty]) {
                            var cubeMapSource = resolveAssetSource_1.default(materialDict[materialProperty][cubeMapTexture]);
                        ...
                        var source = resolveAssetSource_1.default(materialDict[materialProperty]['source']);
                        ...
                        var source = resolveAssetSource_1.default(materialDict[materialProperty]);
     ...
     */
    ViroMaterials.deleteMaterials = function (materials) {
